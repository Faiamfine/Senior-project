...
plt.grid()
plt.savefig(os.path.join(r"D:\Faii\result\Result_final_ml", "acc-traditionalv2-resnet50v2.png"), bbox_inches="tight")
...
plt.legend(['train', 'test'], loc='upper left')
plt.grid()
plt.savefig(os.path.join(r"D:\Faii\result\Result_final_ml", "loss-traditionalv2-resnet50v2.png"), bbox_inches="tight")
#%%
list_val_acc = []
list_val_loss = []
...
plt.legend(loc='best')
plt.savefig(os.path.join(r"D:\Faii\result\Result_final_ml", "each_iter.png"), bbox_inches="tight")
#%%
import pickle
