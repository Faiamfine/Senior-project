# -*- coding: utf-8 -*-
"""
Created on Wed Apr 27 09:22:15 2022

@author: Teerasit_com4
"""
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 20 17:30:35 2022

@author: Teerasit_com4
"""
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 31 21:43:43 2022
...
def kMeanSamples(x_unlabeled, model_feat, model_class, num_samples=50, y_lab=None):
    ...
    for lb in np.unique(labels):
        ...
        print(f"We select {id_labels[id_min]} from {len(id_labels)} for Cluster {lb} with s={s[id_labels[id_min]]}.")
        print(f"Image is labeled with {y_lab[id_labels[id_min]]} and prob: {prob[id_labels[id_min]]}")
...
# %% Complie and save initial model
    ...
    model_feat.save_weights(os.path.join(r'D:\Faii\Dataset_flood\model',
...
# %%
    for k in range(num_iter):
        ...
        # Calculate "U"
        adding_index = kMeanSamples(x_pool, model_feat, model, num_samples=50, y_lab=y_pool)
    ...
    with io.open('kmean_lc_result_val_acc' + str(i),'wb') as f:
        pickle.dump(list_val_acc,f)

    with io.open('kmean_lc_result_val_loss' + str(i),'wb') as f:
        pickle.dump(list_val_loss,f)

    with io.open('kmean_lc_result_train_acc' + str(i),'wb') as f:
        pickle.dump(list_train_acc,f)

    with io.open('kmean_lc_result_train_loss' + str(i),'wb') as f:
