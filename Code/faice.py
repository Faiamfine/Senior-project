...
def get_callbacks():
    model_checkpoint = keras.callbacks.ModelCheckpoint(
        os.path.join(r'D:\Faii\Dataset_flood\model', "activelearningv2-resnet50v2.h5"),
        monitor='val_loss',
        mode='min',
        save_best_only=True
    )
...
model.save_weights(os.path.join(r'D:\Faii\Dataset_flood\model', "activelearning-resnet50v2(initial).h5"))
...
for k in range(num_iter):
    ...
    # Reset weights
    model.load_weights(os.path.join(r'D:\Faii\Dataset_flood\model', "activelearning-resnet50v2(initial).h5"))
...
plt.grid()
plt.savefig(os.path.join(r"D:\Faii\result\Result_final_al", "acc-activelearning-resnet50v2.png"), bbox_inches="tight")
...
plt.legend(['train', 'test'], loc='upper left')
plt.grid()
plt.savefig(os.path.join(r"D:\Faii\result\Result_final_al", "loss-activelearning-resnet50v2.png"), bbox_inches="tight")
#%%
list_val_acc = []
list_val_loss = []
...
plt.savefig(os.path.join(r"D:\Faii\result\Result_final_al", "each_iter.png"), bbox_inches="tight")