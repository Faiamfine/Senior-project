...
model.save_weights(
    os.path.join(
        r"D:\Faii\Dataset_flood\model", "activelearning-resnet50v2(initial).h5"
    )
)
...
plt.savefig(
    os.path.join(
        r"D:\Faii\result\Result_final_al", "acc-activelearning-resnet50v2.png"
    ),
    bbox_inches="tight",
)
...
plt.savefig(
    os.path.join(
        r"D:\Faii\result\Result_final_al", "loss-activelearning-resnet50v2.png"
    ),
    bbox_inches="tight",
)
#%%
