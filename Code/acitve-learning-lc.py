...
for k in range(num_iter):
    ...
    fig.savefig(os.path.join(r"D:\Faii\result_each_iter\LC", f"iter_{k}.png"), bbox_inches="tight")
...
plt.grid()
plt.savefig(os.path.join(r"D:\Faii\result\Result_final_al", "acc-activelearning-LC-resnet50v2.png"), bbox_inches="tight")
...
plt.legend(['train', 'test'], loc='upper left')
plt.grid()
plt.savefig(os.path.join(r"D:\Faii\result\Result_final_al", "loss-activelearning-LC-resnet50v2.png"), bbox_inches="tight")
#%%
list_val_acc = []
list_val_loss = []
